...
<section class="short_descrip">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                        <div class="introduce back-lvwang">
                            <h1><i class="product-icons-64 product-icons-lvwang"></i> some text</h1>
                            <p>
...
<section class="ali_table">
        <div class="container">
        <h4>compared with Troditional server ,ecs 's advantual is obvious</h4>
